...
<body>
    <div class="container">
        ...
        <h3 align="center">ROHIT JAIN D (22005894)</h3>
        <form method="POST">
            {% csrf_token %}
            <div class="calculate"> 
...
def volumecalculation(request):
    ...
    if request.method == 'POST':
        ...
        context['h']=h
        context['w']=w
    return render(request,"volume/math.html",context)
```
- urls.py :
```
...
# OUTPUT:
![Screenshot from 2023-01-16 09-51-12](https://user-images.githubusercontent.com/118707073/212602435-e2b51bca-6712-44bf-8361-6fa897feff09.png)
